...
function Edit({ project }) {
  ...
  const [projectDetails, setProjectDetails] = useState({ title: project?.title, language: project?.language, github: project?.github, link: project?.link, overview: project?.overview, prjctImg: "" })
